...
public class ModifierContrat extends BaseForm {
    ...
    public ModifierContrat(ContratSponsoring c) {
        this(com.codename1.ui.util.Resources.getGlobalResources(), c);
    }
    
    public ModifierContrat(com.codename1.ui.util.Resources resourceObjectInstance, ContratSponsoring c) {
        this.c = c;
        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label("Modifier le contrat", "Title")
                )
        );
        initGuiBuilderComponents(resourceObjectInstance, c);
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance, ContratSponsoring c) {
        ...
        gui_Label_1.setText(c.getPhotoraphe().getNom()+" "+c.getPhotoraphe().getNom());
        ...
        gui_Text_Field_dateDebut.setText(c.getDateDebut().substring(0, 10));
        gui_Text_Field_dateFin.setText(c.getDateFin().substring(0, 10));
        gui_Text_Field_type.setText(c.getType().toString());
        gui_Text_Field_salaire.setText(String.valueOf(c.getSalaireDt()));
...
//-- DON'T EDIT ABOVE THIS LINE!!!
    public void onButton_2ActionEvent(com.codename1.ui.events.ActionEvent ev) {
        ...
        else
        {
            ...
            try {
                        if(ServiceContratSponsoring.getInstance().modifierContrat(c.getID_Contrat(), idSponsor
                                , c.getPhotoraphe().getID_User(), dd, df, type, salaire))
                        {
