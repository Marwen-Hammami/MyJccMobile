...
public class ModifierFilm extends com.codename1.ui.Form {

    public ModifierFilm() {
        this(com.codename1.ui.util.Resources.getGlobalResources());
    }
    
    public ModifierFilm(com.codename1.ui.util.Resources resourceObjectInstance) {
...
//-- DON'T EDIT BELOW THIS LINE!!!
    ...
    private com.codename1.ui.TextField gui_Text_Field_id = new com.codename1.ui.TextField();
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        gui_Component_Group_1.addComponent(gui_Text_Field_id);
        ...
        gui_Text_Field_id.setText("id");
        gui_Text_Field_id.setName("Text_Field_id");
...
//-- DON'T EDIT ABOVE THIS LINE!!!
    ...
    String idStr = gui_Text_Field_id.getText();
    ...
    try {
        if(ServiceFilm.getInstance().updateFilm(id, titre, date, genre, resume, duree, prix, idProducteur, acteur, image)) {
            Dialog.show("Success","Le film a été ajouté avec succès",new Command("OK"));
        } else {
            Dialog.show("ERROR", "Une erreur s'est produite lors de la modification du film", new Command("OK"));
        }
    } catch (Exception e) {
        Dialog.show("ERROR", "Une erreur s'est produite lors de la modification du film", new Command("OK"));
    }
