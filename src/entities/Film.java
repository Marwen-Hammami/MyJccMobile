...
public class Film {
    ...
    public String toString() {
        return "Film{" + "ID_film=" + ID_film + ", Titre=" + Titre + ", DateRealisation=" + DateRealisation + ", Genre=" + Genre + ", Resume=" + Resume + ", Duree=" + Duree + ", Prix=" + Prix + ", ID_producteur=" + ID_producteur + ", Acteur=" + Acteur + '}';
    }*/
