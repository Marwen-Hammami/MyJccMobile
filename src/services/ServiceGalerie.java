    ...
    public ArrayList<Galerie> parseGaleries(String jsonText) {
        try {
            ...
            for (Map<String, Object> obj : list) {
                ...
                photographe.setUsername(photographeJson.get("nom").toString());
                photographe.setGenre(photographeJson.get("genre").toString());
                photographe.setEmail(photographeJson.get("email").toString());
                photographe.setPassword(photographeJson.get("motdepasse").toString());
